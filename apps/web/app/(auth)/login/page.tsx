  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 800px 600px at 50% 0%, rgba(16,185,129,0.04) 0%, transparent 70%)",
        }}
      />
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div
            className="font-serif text-2xl italic mb-1"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="block text-xs font-mono tracking-wider mb-1.5" style={{ color: "var(--text-muted)" }}>
              EMAIL
            </label>
            <input
              type="email"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-lg py-3 text-sm font-semibold cursor-pointer transition-all duration-150"
            style={{
