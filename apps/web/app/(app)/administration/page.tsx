...
import {
  Building2, Key, Activity, Users, CreditCard,
  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 max-w-4xl mx-auto">
      <div className="fade-in mb-10">
        ...
        <p className="lex-page-subtitle">Firm-wide settings, users, and compliance</p>
      </div>
      ...
      <div className="flex gap-6">
        ...
        <div className="fade-in-d2 flex-1 min-w-0">
          <div className="rounded-xl" style={{ background: "rgba(17,17,20,0.7)", border: "0.5px solid rgba(224,224,224,0.09)", padding: 28 }}>
            {renderTab()}
